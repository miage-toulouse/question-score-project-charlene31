...
public class QuestionAChoixMultiple implements QuestionAChoix {
     ...
     */
    public QuestionAChoixMultiple(String enonce, List<Integer> indicesBonnesReponses, int nbReponsePossible) {
        this.enonce = enonce;
        this.indicesBonnesReponses = indicesBonnesReponses;
        this.nbReponsePossible = nbReponsePossible;
    }
    ...
    public float getScoreForIndice(int indiceChoix) {
        if (indicesBonnesReponses.contains(indiceChoix)) {
            ...
            return -100f/(nbReponsePossible-indicesBonnesReponses.size());
        } 
    }
    
    public int getNbReponsePossible(){
        return this.nbReponsePossible;
    }
}
